...
public class JAudioControl extends JComponent implements GameDataChangedListener {
	...
	public JAudioControl(int width, int height, int borderInset, Color bg, Color fg, Color txt) {
		this.width = width;
		this.height = height;
